...
public interface IPrivateVehicleRepo extends JpaRepository<PrivateVehicleDetails,Long>
{
    ...
    List<PrivateVehicleDetails> getPrivateVehicleByPlantIdAndDate(@Param("plantId") Long plantId, @Param("date") LocalDate date);

    List<PrivateVehicleDetails> findByPlant_PlantIDAndOperationDateBetween(Long plantId, LocalDate fromDate, LocalDate toDate);
}
