...
//    @Query("SELECT o FROM PlantOperation o WHERE o.plant.plantID = :plantId")
//    public Optional<PlantOperation> getOperationByPlantId(@Param("plantId") Long plantId);

//    @Query("SELECT o FROM PlantOperation o WHERE o.plant.plantID = :plantId AND o.operationDate = :opDate")
//    Optional<PlantOperation> getOperationByPlantIdAndDate(
//            @Param("plantId") Long plantId,
//            @Param("opDate") LocalDate opDate
//    );
//
//    @Query("SELECT p FROM FstpPlant p WHERE p.plantID = :plantID")
//    Optional<FstpPlant> findPlantByPlantID(@Param("plantID") Long plantID);
